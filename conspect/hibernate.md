...
На картинке выше employees, это source-таблица, а departments - target-таблица. В отношении "много к одному" (а это перевернутое отношение "один ко многим") FK всегда находится в таблице, "где много".   
Иногда (например, в другом отношении) FK может находиться не в target-таблице. Мы все равно 
